...
if __name__ == '__main__':
    ...
    parser.add_argument("--run_dir", type=str, default="/home/seif_elkerdany/projects/modeling/model/runs/siamese_B3.1_net", help="TensorBoard log directory.")
    parser.add_argument("--checkpoint_dir", type=str, default="/home/seif_elkerdany/projects/modeling/model/checkpoints/B3.1", help="Directory to save model checkpoints and plots.")
